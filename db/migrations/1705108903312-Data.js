module.exports = class Data1705108903312 {
    name = 'Data1705108903312'

    async up(db) {
        await db.query(`CREATE TABLE "cheque" ("id" character varying NOT NULL, "from" text NOT NULL, "to" text NOT NULL, "amount" numeric NOT NULL, "token_address" text, "memo" text, "fee" numeric NOT NULL, "status" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_bf81eabc52f4f3320378a80f77e" PRIMARY KEY ("id"))`)
